...
const memory = {
  ...
  images: {
    memory: images.frames.memory,
    illusion: images.frames.illusion,
    revelations: images.frames.revelations,
    monument: images.frames.monument,
    war: images.frames.war,
    human: images.frames.human,
    conflict: images.frames.conflict,
    movement: false,
    time: images.frames.time
  },
  videos: {
    memory: [
      {
  ...
  texts: {
    memory: {
      rus: [
        ...
        `Гигантские мечи. В детстве мама рассказывала про атлантов, которые населяли Землю. Не могу отделаться от мысли, что это они оставили свое оружие. Хотя раньше всегда представляла атлантов безоружными. (Лиза)`,
        `Войны былых поколений врастают памятниками на тихих лугах и здесь тот самый случай. Почва принимает всех и вся, не делая исключений. Испытывает ли она боль от людских конфликтов? Есть ощущение, что нет. Ибо на любое действие, у природы есть противодействие, мудрый и расчетливый ответ.`,
        `«Лес - это очень важно. Он дает дому тепло и уют, дарит нам чистый воздух, физическое и психическое здоровье, приключения и свободу. В лесу были побеждены римляне, лес служил основой немецкой экономики, под деревьями зародился романтизм 18-ого века, и экологические движения 20-ого века» (отрывок из книги “Тайная жизнь деревьев” Петера Вольлебена)`,
...
export { main, instruction, memory };
